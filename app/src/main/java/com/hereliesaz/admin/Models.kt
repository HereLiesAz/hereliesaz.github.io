...
data class SiteContent(
    ...
    companion object {
        const val DEFAULT_ABOUT = "The canvas is a closet. The paint is light. You navigate the dark by following what your eye almost-recognises."
...
data class SanitizedFile(val id: String, val filename: String)
